    ...
    def create_dataset(self):
        ...
        for file in os.listdir(self.path):
            if file.endswith(".csv"):
                ...
                dataset = pd.concat([dataset, data], axis=0, ignore_index=True, copy=False)
...
def load_scaler(path: str='/home/abhishek/Brain-Computer-Interface/bci_py_ws/src/bci_package/weights/scaler.pkl') -> StandardScaler:
...
MODEL_PATH = '/home/abhishek/Brain-Computer-Interface/bci_py_ws/src/bci_package/weights/ensemble_model.pkl'
with open(MODEL_PATH, 'rb') as f:
    ensemble_model = pickle.load(f)
        
# Store predictions
# After your existing prediction line
y_pred = ensemble_model.predict(X_test.iloc[:, 1:])

# Add this to print predictions
...
# Still keep accuracy score if you want
